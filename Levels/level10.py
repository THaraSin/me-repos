...
class Level10(Entity):
    def __init__(self):
        ...
        self.block_10_4 = BreakBlock(position = (0, 10, 150))
        ...
        self.block_10_21 = AbnorBlock(position = (0, 20, 220))
    ...
    def update(self):
        ...
        if self.ground_10.enabled == True:
            ...
            if hit.entity == self.block_10_5:
                self.player.SPEED = normalSpeed
            
            if hit.entity == self.block_10_7:
                self.player.SPEED = normalSpeed
            
            if hit.entity == self.block_10_9:
                self.player.SPEED = normalSpeed

            if hit.entity == self.block_10_10:
                self.player.SPEED = normalSpeed
            
            if hit.entity == self.block_10_11:
                self.player.SPEED = normalSpeed
            
            if hit.entity == self.block_10_12:
                self.player.SPEED = normalSpeed
            
            if hit.entity == self.block_10_13:
                self.player.SPEED = normalSpeed

            if hit.entity == self.block_10_14:
                self.player.SPEED = normalSpeed

            if hit.entity == self.block_10_15:
                self.player.SPEED = normalSpeed

            if hit.entity == self.block_10_16:
                self.player.SPEED = normalSpeed
            
            if hit.entity == self.block_10_17:
                self.player.SPEED = normalSpeed
            
            if hit.entity == self.block_10_18:
                self.player.SPEED = normalSpeed

            if hit.entity == self.block_10_19:
                self.player.SPEED = normalSpeed
            ...
            if hit.entity == self.block_10_22:
                self.player.SPEED = normalSpeed
            
            if hit.entity == self.block_10_23:
                self.player.SPEED = normalSpeed
            
            if hit.entity == self.block_10_24:
                self.player.SPEED = normalSpeed
            
            if hit.entity == self.block_10_25:
                self.player.SPEED = normalSpeed
